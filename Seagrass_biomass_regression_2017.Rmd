...
ggplot(newdata_lm4, aes(x = log(length_cm), y = fit)) + geom_point() + theme_classic() + geom_smooth(method = "lm")

newdata_lm422 <- cbind(eel.lngs22, pr.lm4.22)

newdata_lm421 <- cbind(eel.lng21, pr.lm4.21)
...
#write.csv(lng21.biomass, "Data/hab_length_2021_Zosbiomass_3-14-23.csv")
#write.csv(lng22.biomass, "Data/hab_length_2022_Zosbiomass_3-14-23.csv")
```
...
range(df3_lm4$avg_biomass) # 0.00179 - 0.004, 0.02 - 0.5
```
