...
```{r}
pink4 <- gam(abundance ~ Habitat + Mon + s(Lat1, Long1, k = 2), data = pink.long, 
    family = "nb", method = "ML") # might be worth comparing the s versus te (tensoor field), if the k is unconstrained than with the s it takes k == 2 and te it takes 3
...
```{r}
chum4 <- gam(abundance ~ Habitat + Mon + s(Lat1, Long1, k = 2), data = chum.long, 
    family = "nb", method = "ML") # might be worth comparing the s versus te (tensoor field), if the k is unconstrained than with the s it takes k == 2 and te it takes 3
...
hab <- ggplot(pr.hab.df) +
  ...
  ylim(c(-0.1, 20)) +
  plot_theme() +
  labs(y = "Log Average Pink Salmon (#/seine)")
hab
...
habc <- ggplot(pr.habc.df) +
  ...
  ylim(c(-0.1, 7)) +
  plot_theme() +
  labs(y = "Log Average Chum Salmon (#/seine)")
habc
