...
pink.full.mod.red <- glm.nb(SALPINK ~ year + juli_date + I(juli_date^2) + avg_biom_site_gm2 + avg_density + dist_anad_km + sed1_avg, data = fish[-c(16, 37)], control=glm.control(maxit = 100), init.theta = 0.495)
...
# refit w/o pot outliers
pink.mod1.red <- glm.nb(SALPINK ~ juli_date + I(juli_date^2) + avg_biom_site_gm2 + avg_density + dist_anad_km + sed1_avg, data = fish[-c(16,37)], control=glm.control(maxit = 100), init.theta = 0.495)
...
#write.csv(pink.cand.tbl, file = "Data/Pink_candidate_mod_tbl_9-4-23.csv")
...
#ggsave("chp1_obj2_pink_plot.png", plot = pink.plot, width = 14, height = 10)
```
...
#write.csv(chum.cand.tbl, file = "Data/Chum_candidate_mod_tbl_9-4-23.csv")
...
#ggsave("chp1_obj2_chum_plot.png", plot = chum.plots, width = 14, height = 6)
```
