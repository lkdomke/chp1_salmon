...
AICc(pink.intx);AICc(pink.full.mod);AICc(pink.mod1);AICc(pink.mod2);AICc(pink.mod2.2); AICc(pink.mod3)
AICc(pink.intx.red);AICc(pink.full.mod.red);AICc(pink.mod1.red);AICc(pink.mod2.red);AICc(pink.mod3.red)
...
pink.plot <- add_global_label(pinks, Ylab = "Pink Salmon (#/seine)",
                 size = 8.25)
pink.plot
summary(pink.mod2)
...
chum1 <- visreg(chum.mod5, "juli_date", 
       scale = "response", gg = TRUE, rug = F, partial = F,line.par = list(col = 'black')) + 
  xlab(expression(paste("Day of year"))) + 
  ylab("Chum Salmon (#/seine)") + coord_cartesian(ylim = c(0,300)) +
    geom_point(data = fish, aes(x = juli_date, y = SALCHUM)) + 
  plot_theme()
chum1
