...
pink.mod2.red <- glm.nb(SALPINK ~ juli_date + I(juli_date^2) + avg_biom_site_gm2 + avg_density + dist_anad_km, 
                        data = fish[-c(16,37)], control=glm.control(maxit = 100))
...
#write.csv(pink.cand.tbl, file = "Data/Pink_candidate_mod_tbl_2-26-24.csv")
